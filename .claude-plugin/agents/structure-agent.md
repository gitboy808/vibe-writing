...
| 时机 | 文件 | 目的 |
|------|------|------|
| 深度分析前 | `项目信息.md` | 获取待转化列表、已输出卡片 |
| 深度分析前 | `初始文档.md` | 理解选题背景 |
| 深度分析前 | 待转化的知识卡片 | 分析核心价值点 |
| 深度分析前 | 已有的输出卡片 | 了解已完成内容 |
| 价值点分析时 | 当前选中的知识卡片 | 深度提取价值 |
| 生成首版时 | `初始文档.md` | 补充背景资料 |
| 生成首版时 | 已有的输出卡片 | 确保衔接 |
...
| 时机 | 文件 | 更新内容 |
|------|------|----------|
| 生成首版后 | `项目信息.md` | 添加输出卡片到列表 |
| 生成首版后 | `项目信息.md` | 移除待转化列表中的卡片 |
| 生成首版后 | `项目信息.md` | 更新"文章结构分析" |
| 生成首版后 | `输出卡片/[主题名]/01-XX.md` | 创建节点文件 |

### 项目信息.md 字段责任

| 字段 | 责任方 | 更新时机 |
|------|--------|----------|
| 输出卡片列表 | structure-agent | 生成首版后 |
| 待转化列表 | structure-agent | 生成首版后（移除已转化） |
| 文章结构分析 | structure-agent | 生成首版后（1-2句话记录） |
| 当前阶段 | structure-agent | 可选更新（保持"结构"或改为"写作"） |
