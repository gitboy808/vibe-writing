...
**版本**: v0.9.1 | **Claude Code Plugin**

平等对话的思维协同写作系统 - 相互质疑、共同探索，AI敢于纠错、激发、引导，最终文章是"你的"，不是AI代写的。
...
- 对话探索时，AI敢于指出你的理解偏差
- 分析价值点时，我们一起决定讲述逻辑
- 迭代优化时，你把控内容，AI提供独立观点
- 成稿串联时，AI检查整体逻辑是否连贯

### 最终文章是"你的"

不是AI代写，是平等对话、相互质疑后，AI帮你整理和优化的结果。
...
│   └── references/           # 参考文档
│       ├── core-specs.md         # 核心规范
│       ├── format-standards.md   # 格式标准
│       ├── canvas-operations.md  # Canvas操作
│       └── example-project.md    # 完整示例项目
├── CLAUDE.md                  # 主 Agent 路由规则
└── README.md                  # 本文档（项目首页）
```
...
- **参考规范**：查看 `.claude-plugin/references/`
  - `core-specs.md` - 项目结构和路径规范
  - `format-standards.md` - 文件格式标准
  - `canvas-operations.md` - Canvas 操作规范
  - `example-project.md` - 完整示例项目
- **开发文档**：查看 `CLAUDE.md`
